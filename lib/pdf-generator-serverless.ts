// For production/serverless environments, install these packages:
...
export async function generatePayslipPDF(payslipData: PayslipData): Promise<Buffer> {
  ...
  try {
    // Determine if we're in production/serverless
...
// Copy the generatePayslipHTML function from the previous artifact here
  ...
  <div class="container">
    ...
    <div class="header">
      ...
      <div class="payslip-info">
        ...
        <h2>PAYSLIP</h2>
        <p>${getMonthYearDisplay(data.payreoll.monthYear)}</p>
      </div>
    </div>
